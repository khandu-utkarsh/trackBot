...
class User(BaseModel):
    ...
    email: StrictStr = Field(description="User's email address. This is the primary key for the user and obtained from the Google Auth.")
    created_at: datetime = Field(description="Timestamp when the user was created. Created by the database.")
