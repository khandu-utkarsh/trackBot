...
from trackbot_api.models.cardio_exercise import CardioExercise
from trackbot_api.models.weight_exercise import WeightExercise
...
class Exercise(BaseModel):
    ...
    one_of_schemas: List[str] = Literal["CardioExercise", "WeightExercise"]
