...
class MessagesApi:
    ...
    def _create_message_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/users/{userId}/conversations/{conversationId}/messages',
    ...
    def delete_message(
        ...
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        conversation_id: Annotated[int, Field(strict=True, ge=1, description="Conversation ID")],
        message_id: Annotated[int, Field(strict=True, ge=1, description="Message ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_message_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/users/{userId}/conversations/{conversationId}/messages/{messageId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
