...
class Workout(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Unique identifier for the workout.")
    user_id: StrictInt = Field(description="ID of the user who owns the workout.")
    created_at: datetime = Field(description="When the workout was created.")
    updated_at: datetime = Field(description="When the workout was last updated.")
