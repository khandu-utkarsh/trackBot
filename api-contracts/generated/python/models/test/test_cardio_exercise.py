...
from trackbot_models.models.cardio_exercise import CardioExercise  # noqa: E501

class TestCardioExercise(unittest.TestCase):
    """CardioExercise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardioExercise:
        """Test CardioExercise
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardioExercise`
        """
        model = CardioExercise()  # noqa: E501
        if include_optional:
