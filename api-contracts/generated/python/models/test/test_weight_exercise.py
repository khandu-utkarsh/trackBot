...
from trackbot_models.models.weight_exercise import WeightExercise  # noqa: E501

class TestWeightExercise(unittest.TestCase):
    """WeightExercise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeightExercise:
        """Test WeightExercise
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeightExercise`
        """
        model = WeightExercise()  # noqa: E501
        if include_optional:
