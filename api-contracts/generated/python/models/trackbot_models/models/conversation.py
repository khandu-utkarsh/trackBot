...
class Conversation(BaseModel):
    ...
    Conversation
    """
    id: StrictInt = Field(default=..., description="Unique identifier for the conversation. Created by the database.")
    user_id: StrictInt = Field(default=..., description="ID of the user who owns this conversation. Obtained from the user table.")
    title: StrictStr = Field(default=..., description="Title of the conversation. This is the title of the conversation.")
    created_at: datetime = Field(default=..., description="Timestamp when the conversation was created. Created by the database.")
    __properties = ["id", "user_id", "title", "created_at"]
