...
class CreateWorkoutResponse(BaseModel):
    ...
    """
    id: StrictInt = Field(default=..., description="ID of the created workout")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWorkoutResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWorkoutResponse:
        """Create an instance of CreateWorkoutResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateWorkoutResponse.parse_obj(obj)

        _obj = CreateWorkoutResponse.parse_obj({
            "id": obj.get("id")
        })
        return _obj
