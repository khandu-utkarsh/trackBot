...
class CreateExerciseResponse(BaseModel):
    ...
    """
    id: StrictInt = Field(default=..., description="ID of the created exercise")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateExerciseResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateExerciseResponse:
        """Create an instance of CreateExerciseResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateExerciseResponse.parse_obj(obj)

        _obj = CreateExerciseResponse.parse_obj({
            "id": obj.get("id")
        })
        return _obj
