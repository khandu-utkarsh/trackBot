...
class CreateConversationResponse(BaseModel):
    ...
    """
    id: StrictInt = Field(default=..., description="ID of the created conversation. Created by the database.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateConversationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateConversationResponse:
        """Create an instance of CreateConversationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateConversationResponse.parse_obj(obj)

        _obj = CreateConversationResponse.parse_obj({
            "id": obj.get("id")
        })
        return _obj
