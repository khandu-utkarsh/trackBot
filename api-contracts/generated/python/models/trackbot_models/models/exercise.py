...
class Exercise(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[CardioExercise, WeightExercise]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(EXERCISE_ONE_OF_SCHEMAS, const=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Exercise:
