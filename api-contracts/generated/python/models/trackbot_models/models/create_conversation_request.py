...
class CreateConversationRequest(BaseModel):
    ...
    """
    title: StrictStr = Field(default=..., description="Title of the conversation")
    __properties = ["title"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateConversationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateConversationRequest:
        """Create an instance of CreateConversationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateConversationRequest.parse_obj(obj)

        _obj = CreateConversationRequest.parse_obj({
            "title": obj.get("title")
        })
        return _obj
