...
class CreateMessageResponse(BaseModel):
    ...
    """
    id: StrictInt = Field(default=..., description="ID of the created message. Created by the database.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMessageResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMessageResponse:
        """Create an instance of CreateMessageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMessageResponse.parse_obj(obj)

        _obj = CreateMessageResponse.parse_obj({
            "id": obj.get("id")
        })
        return _obj
