...
class UpdateWorkoutRequest(BaseModel):
    ...
    """
    user_id: Optional[StrictInt] = Field(default=None, description="ID of the user who owns the workout")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateWorkoutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateWorkoutRequest:
        """Create an instance of UpdateWorkoutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateWorkoutRequest.parse_obj(obj)

        _obj = UpdateWorkoutRequest.parse_obj({
