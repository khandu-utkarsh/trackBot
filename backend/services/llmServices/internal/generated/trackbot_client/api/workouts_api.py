...
class WorkoutsApi:
    ...
    def _delete_workout_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/users/{userId}/workouts/{workoutId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def users_user_id_workouts_get(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        ...
        _param = self._users_user_id_workouts_get_serialize(
            user_id=user_id,
            year=year,
            month=month,
            day=day,
    ...
    @validate_call
    def users_user_id_workouts_get_with_http_info(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        year: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by year (YYYY format)")] = None,
        month: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by month (MM format)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListWorkoutsResponse]:
        """List workouts for a user
    ...
    @validate_call
    def users_user_id_workouts_get_without_preload_content(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        year: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by year (YYYY format)")] = None,
        month: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="Filter by month (MM format)")] = None,
    ...
    def _users_user_id_workouts_get_serialize(
        self,
        user_id,
        year,
        month,
