...
class ListMessagesRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["conversation_id", "user_id", "limit", "offset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMessagesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMessagesRequest from a dict"""
        if obj is None:
            return None
