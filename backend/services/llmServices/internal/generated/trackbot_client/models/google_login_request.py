...
class GoogleLoginRequest(BaseModel):
    ...
    """ # noqa: E501
    google_token: StrictStr = Field(description="Google JWT credential token", alias="googleToken")
    __properties: ClassVar[List[str]] = ["googleToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "googleToken": obj.get("googleToken")
        })
        return _obj
