...
class ConversationsApi:
    ...
    def _create_conversation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/users/{userId}/conversations',
    ...
    def delete_conversation(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        conversation_id: Annotated[int, Field(strict=True, ge=1, description="Conversation ID")],
        delete_conversation_request: Optional[DeleteConversationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param delete_conversation_request:
        :type delete_conversation_request: DeleteConversationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _delete_conversation_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_conversation_request is not None:
            _body_params = delete_conversation_request
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/users/{userId}/conversations/{conversationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_conversation_by_id(
        ...
        _param = self._get_conversation_by_id_serialize(
            user_id=user_id,
            conversation_id=conversation_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_conversation_by_id_with_http_info(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        conversation_id: Annotated[int, Field(strict=True, ge=1, description="Conversation ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_conversation_by_id_without_preload_content(
        self,
        user_id: Annotated[int, Field(strict=True, ge=1, description="User ID")],
        conversation_id: Annotated[int, Field(strict=True, ge=1, description="Conversation ID")],
        _request_timeout: Union[
    ...
    def _get_conversation_by_id_serialize(
        self,
        user_id,
        conversation_id,
        _request_auth,
