...
class LLMServiceMessageRequest(BaseModel):
    """
    Request to the LLM service to process a conversation.
    """ # noqa: E501
    messages: List[Message]
    user_id: StrictInt = Field(description="ID of the user making the request.")
    conversation_id: StrictInt = Field(description="ID of the conversation to which these messages belong.")
    __properties: ClassVar[List[str]] = ["messages", "user_id", "conversation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LLMServiceMessageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LLMServiceMessageRequest from a dict"""
        if obj is None:
            return None
