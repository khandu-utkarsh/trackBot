...
class LLMServiceMessageResponse(BaseModel):
    """
    Response from the LLM service to process a conversation.
    """ # noqa: E501
    message: Message
    response_time_ms: Optional[StrictInt] = Field(default=None, description="Time taken to generate the response in milliseconds.")
    model_name: Optional[StrictStr] = Field(default=None, description="Identifier of the model used to generate the response.")
    __properties: ClassVar[List[str]] = ["message", "response_time_ms", "model_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LLMServiceMessageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LLMServiceMessageResponse from a dict"""
        if obj is None:
            return None
