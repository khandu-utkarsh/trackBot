...
from trackbot_client.api_response import ApiResponse, T as ApiResponseT
import trackbot_client.models
from trackbot_client import rest
from trackbot_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(trackbot_client.models, klass)
